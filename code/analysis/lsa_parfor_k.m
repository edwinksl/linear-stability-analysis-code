function varargout = lsa_parfor_k(base, str, bc_index, t_index, ks, solver_index, save_flag, lsa_dir)
  ...
  if save_flag == 1
    ...
    % save([lsa_full_dir, filename, '.mat'], 'omega_mu', 'base', 'v_mu', 'bc_index', 't_index', 'ks', 'solver_index')
    save([lsa_full_dir, filename, '.mat'], 'omega_mu', 'base', 'h_1_a_mu', 'h_1_c_mu', 'bc_index', 't_index', 'ks', 'solver_index')
  end
